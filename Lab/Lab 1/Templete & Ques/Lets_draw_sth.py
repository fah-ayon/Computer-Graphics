...
def mouse_listener(button, state, x, y):
    ...
    """
    global ball_x, ball_y, new_point, ball1x, ball1y
    if button == GLUT_LEFT_BUTTON and state == GLUT_DOWN:
        ...
        ball1x, ball1y = convert_coordinate(x, y)
        new_point=True
...
def animate():
    ...
    global ball_x, ball_y, ball_speed, ball1x, ball1y
    ball_x = (ball_x + ball_speed) % 180
    ball_y = (ball_y + ball_speed) % 180
    ball1x = (ball1x + ball_speed) % 180
    ball1y = (ball1y + ball_speed) % 180
    glutPostRedisplay()
...
def main():
    ...
    glutCreateWindow(b"Animation Part")
